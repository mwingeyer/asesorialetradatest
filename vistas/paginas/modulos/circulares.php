<?php
   ...
   /* if ($_SERVER["HTTP_HOST"] == "localhost" && $_SERVER["SERVER_NAME"] == "localhost" && $_SERVER["SERVER_ADDR"] == "::1" && $_SERVER["REMOTE_ADDR"] == "::1") {
        $urldominio = "http://sanjuan.gob.ar/ol/";
    }
    else {
        $urldominio = "http://10.2.132.74/ol/";
    }*/
    // $urldominio = "https://sanjuan.gob.ar/ol/";
   ...
   // NULL $json=file_get_contents($urllic);
							...
							if ($nombre == 'Circular') {
								...
								if($id <= 3){
									...
									echo '<div class="col-lg-12">
										  ...
										  <h4 class="d-lg-block">'.$asiento.''."-ALG-".'</h4>
		                         ...
		                         for($i=0;$i<$cantidad;$i++){
									...
									if ($nombre == 'Circular') {
										...
										if($id <= 3){
									        ...
									        <td><h6>'.$asiento.'</h6></td>
									        <td>
									        	<button data-toggle="modal" data-target="#verCircular" type="button" class="btn border-0 text-white flex right" style="background: #B71C1C">
